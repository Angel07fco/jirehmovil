...
export default function plancachorro() {
    ...
    <View className="w-full flex-1">
      <View className="bg-secondaryBlue flex-row items-center w-full h-20">
        ...
        <Text className="text-primaryBlue font-bold text-2xl ml-5">
          Plan de salud para cachorros
        </Text>
      </View>
      <ScrollView showsVerticalScrollIndicator={false}>
        <View className="w-full mt-6 px-6">
          <Text className="text-base">
            Este es un plan diseñado para cubrir las necesidades de los primero
            meses de tu cachorro. Incluye todos los servicios veterinarios
            necesarios para que tu cachorro crezca sano y fuerte.
          </Text>
        </View>
        ...
        <View className="w-full flex-row my-4">
          <View className="w-[30%]">
            ...
            <View className="h-[60px] justify-center bg-primaryBlue items-center border-b border-gray-400">
              <Text className="text-lg font-bold">Especial cachorro</Text>
            </View>
          </View>
          ...
          <View className="w-[25%]">
            ...
            <View className="h-[42px] justify-center items-center border-b border-gray-400">
              <Text className="text-secondaryBlue text-base">3</Text>
            </View>
