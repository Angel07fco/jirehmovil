...
export default function plansenior() {
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View className="w-full mt-6 px-6">
          <Text className="text-base">
            Sabemos que no es fácil encontrar planes de salud para perros
            senior, pero en JIREH sí le damos importancia a los cuidados
            necesarios para tu perro durante esta etapa de la vida.
          </Text>
        </View>
